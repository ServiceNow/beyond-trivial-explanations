...
class Resnet50_128(nn.Module):
    ...
    def forward(self, data, return_preflatten=False):
        ...
        data = torch.nn.functional.interpolate(data, size=(224,224), scale_factor=None, mode='bicubic', align_corners=None, recompute_scale_factor=None)
...
def resnet50_128(exp_dict, weights_path, **kwargs):
    """
    ...
    """
    model = Resnet50_128(exp_dict['n_classes'])
    if weights_path:
